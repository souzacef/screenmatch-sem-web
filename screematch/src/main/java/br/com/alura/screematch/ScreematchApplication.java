...
//		json = consumoAPI.ObterDados("https://coffee.alexflipnote.dev/random.json");
		...
		json = consumoAPI.ObterDados("http://www.omdbapi.com/?t=gilmore+girls&Season=1&episode=2&apikey=9f11e664");
		...
		for (int i = 1; i<=dados.totalTemporadas(); i++) {
			...
			json = consumoAPI.ObterDados("http://www.omdbapi.com/?t=gilmore+girls&Season=" + i + "&apikey=9f11e664");
